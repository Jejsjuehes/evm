...
const main = async () => {
  ...
  for (const privateKey of privateKeys) {
    ...
    if (senderBalance < ethers.parseUnits("0.00001", "ether")) {
      console.log(colors.red("❌ Insufficient or zero balance, under 0.00001 eth. Skipping to next address."));
      continue;
    }
    ...
    for (let i = 1; i <= transactionCount; i++) {
      ...
      private key: ${receiverWallet.privateKey}
      mnemonic: ${receiverWallet.mnemonic}
      ==================================`;
      fs.appendFileSync("newWallets.txt", data);
